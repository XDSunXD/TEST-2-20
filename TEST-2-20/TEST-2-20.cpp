...
//	Ptr<ORB> detector1 = ORB::create();
//	Ptr<ORB> detector2 = ORB::create();
//
//	//cv::Ptr<cv::xfeatures2d::SIFT> detector1 = cv::xfeatures2d::SIFT::create();
//	//cv::Ptr<cv::xfeatures2d::SIFT> detector2 = cv::xfeatures2d::SIFT::create();
//
//	//cv::Ptr<cv::xfeatures2d::SURF> detector1 = cv::xfeatures2d::SURF::create();
//	//cv::Ptr<cv::xfeatures2d::SURF> detector2 = cv::xfeatures2d::SURF::create();
//
//	detector1->detect(obj, obj_keypoints);
//	detector1->detect(scene, scene_keypoints);
//	detector2->compute(obj, obj_keypoints, obj_descriptors);
//	detector2->compute(scene, scene_keypoints, scene_descriptors);
//	BFMatcher matcher(NORM_L1, true); //汉明距离做为相似度度量   
...
//	H12 = findHomography(Mat(points1), Mat(points2));          //单应性矩阵
//	//H12 = findFundamentalMat(Mat(points1), Mat(points2));    //基础矩阵
